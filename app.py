...
class App:
    ...
    def tabHome(self):
        ...
        **Logic and Observations**
        ...
        - Watch bridges that connect L2s/ EVM chains to Bitcoin and Solana. People have been moving an [outsized amount of value to Solana](https://twitter.com/Uptodatenow/status/1729618239905239177) and [Bitcoin liquidity on Thorchain](https://app.thorswap.finance/dashboard) has been mooning.
